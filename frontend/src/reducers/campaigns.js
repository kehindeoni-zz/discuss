...
export function campaign(state = DEFAULT_STATE, action) {
  switch (action.type) {
    case campaignConstant.GET_CAMPAIGNS_START:
      return Object.assign({}, state, { fetching: true, viewingCampaign: false });
    case campaignConstant.GET_CAMPAIGNS_SUCCESS:
      return Object.assign({}, state, { fetching: false, campaigns: action.campaigns, viewingCampaign: false });
    case campaignConstant.GET_CAMPAIGNS_FAILURE:
      return Object.assign({}, state, { fetching: false, viewingCampaign: false });
